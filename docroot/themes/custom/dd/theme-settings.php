 ...
 */
function dd_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  // Work-around for a core bug affecting admin themes. See issue #943212.
  if (isset($form_id)) {
    return;
  }

  $form['logo']['show_powered_by_dd'] = [
    '#type' => 'checkbox',
    '#title' => t('Show Powered By Digital Democracy in header'),
    '#default_value' => theme_get_setting('show_powered_by_dd'),
  ];

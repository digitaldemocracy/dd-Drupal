...
// Whitelabel machine ID detection
var argv = require('yargs').argv;
var whitelabel_id = (argv.whitelabel_id === undefined) ? '' : argv.whitelabel_id;
if (argv.whitelabel_id) {
  console.log('Whitelabel ID selected: ' + argv.whitelabel_id);
}
...
options.sass = {
  ...
  // @todo Remove source comments from production builds
  sourceComments: true
};
...
options.styleGuide = {
  ...
  css: [
    ...
    path.relative(options.rootPath.styleGuide, options.theme.css + 'jquery-ui.css'),
    path.relative(options.rootPath.styleGuide, options.theme.css + 'kss-only.css'),
    // component stylesheets
    path.relative(options.rootPath.styleGuide, options.theme.css + 'account.css'),
    path.relative(options.rootPath.styleGuide, options.theme.css + 'analysis-menu.css'),
    path.relative(options.rootPath.styleGuide, options.theme.css + 'blocks/agendized-bills.css'),
    path.relative(options.rootPath.styleGuide, options.theme.css + 'blocks/participation.css'),
    path.relative(options.rootPath.styleGuide, options.theme.css + 'blocks/utterance.css'),
    ...
    path.relative(options.rootPath.styleGuide, options.theme.css + 'committees.css'),
    path.relative(options.rootPath.styleGuide, options.theme.css + 'footer.css'),
    path.relative(options.rootPath.styleGuide, options.theme.css + 'gift-contribution.css'),
    path.relative(options.rootPath.styleGuide, options.theme.css + 'header.css'),
    path.relative(options.rootPath.styleGuide, options.theme.css + 'hearings-teaser.css'),
    ...
    path.relative(options.rootPath.styleGuide, options.theme.css + 'homepage.css'),
    ...
    path.relative(options.rootPath.styleGuide, options.theme.css + 'organizations.css'),
    ...
    path.relative(options.rootPath.styleGuide, options.theme.css + 'showhide.css'),
    path.relative(options.rootPath.styleGuide, options.theme.css + 'video-thumb-wrapper.css'),
    ...
    path.relative(options.rootPath.styleGuide, options.theme.css + 'user-account.css'),
    // form stylesheets
  ...
  js: [
    path.relative(options.rootPath.styleGuide, options.rootPath.theme + '../../../core/assets/vendor/jquery/jquery.min.js'),
    path.relative(options.rootPath.styleGuide, options.rootPath.theme + '../../../core/assets/vendor/domready/ready.min.js'),
    path.relative(options.rootPath.styleGuide, options.rootPath.theme + '../../../core/misc/drupal.js'),
    path.relative(options.rootPath.styleGuide, options.theme.js + 'showhide.js')
  ],

  homepage: 'homepage.md',
  title: 'dd Style Guide'
};
...
options.eslint = {
  files  : [
    ...
    options.theme.libraries + '**/*.js',
    '!' + options.theme.libraries + '**/*.min.js',
...
gulp.task('styles', function () {
  return gulp.src(sassFiles)
    .pipe(header('$whitelabel-id: \'' + whitelabel_id + '\';\n'))

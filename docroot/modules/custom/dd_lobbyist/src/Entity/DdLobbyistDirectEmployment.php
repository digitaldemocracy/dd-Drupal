...
/**
 * Defines the DD LobbyistDirectEmployment entity.
 *
 * @ingroup dd_lobbyist
 *
 * @ContentEntityType(
 *   id = "dd_lobbyist_directemployment",
 *   label = @Translation("DD LobbyistDirectEmployment"),
 *   handlers = {
 ...
 *     "views_data" = "Drupal\dd_lobbyist\Entity\DdLobbyistDirectEmploymentViewsData"
 *   },
 *   base_table = "LobbyistDirectEmployment",
 *   entity_keys = {
 *     "id" = "dr_id",
 *     "label" = "rpt_date_ts"
 *   },
 * )
 */
class DdLobbyistDirectEmployment extends DdBaseStateField implements DdLobbyistDirectEmploymentInterface {
